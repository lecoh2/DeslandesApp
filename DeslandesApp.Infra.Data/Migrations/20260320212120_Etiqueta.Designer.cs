...
namespace DeslandesApp.Infra.Data.Migrations
{
    ...
    [Migration("20260320212120_Etiqueta")]
            ...
            modelBuilder.Entity("DeslandesApp.Domain.Models.Entities.GrupoAtendimentoCliente", b =>
                {
                    ...
                    b.HasKey("AtendimentoId", "PessoaId")
                        .HasName("PK_ATENDIMENTCLIENTE");

                    b.HasIndex("PessoaId")
                        .HasDatabaseName("IX_ATENDIMENTCLIENTE_PESSOAID");

                    b.ToTable("ATENDIMENTCLIENTE", (string)null);
                });
            ...
            modelBuilder.Entity("DeslandesApp.Domain.Models.Entities.GrupoAtendimentoEtiqueta", b =>
                {
                    ...
                    b.HasKey("AtendimentoId", "EtiquetaId")
                        .HasName("PK_ATENDIMENTO_ETIQUETA");

                    b.HasIndex("EtiquetaId")
                        .HasDatabaseName("IX_ATENDIMENTO_ETIQUETA_ETIQUETAID");

                    b.ToTable("ATENDIMENTO_ETIQUETA", (string)null);
                });
            ...
            modelBuilder.Entity("DeslandesApp.Domain.Models.Entities.GrupoAtendimentoCliente", b =>
                {
                    ...
                    b.HasOne("DeslandesApp.Domain.Models.Entities.Pessoa", "Pessoa")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_ATENDIMENTCLIENTE_PESSOA_PESSOAID");
            ...
            modelBuilder.Entity("DeslandesApp.Domain.Models.Entities.GrupoAtendimentoEtiqueta", b =>
                {
                    ...
                    b.HasOne("DeslandesApp.Domain.Models.Entities.Etiqueta", "Etiqueta")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_ATENDIMENTO_ETIQUETA_ETIQUETA_ETIQUETAID");
