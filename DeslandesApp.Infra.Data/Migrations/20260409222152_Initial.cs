        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SEXOID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    EMAIL = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TIPO_CONTA_ID = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PROCESSOETIQUETA", x => new { x.PROCESSOID, x.ETIQUETAID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GRUPOTAREFARESPONSAVEIS", x => new { x.PESSOAID, x.TAREFAID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PROCESSOHISTORICO_PROCESSOID",
                table: "PROCESSOHISTORICO",
                column: "PROCESSOID");
