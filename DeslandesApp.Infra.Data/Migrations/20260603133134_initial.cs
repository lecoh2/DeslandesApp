    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CONTRATO_PROCESSO", x => new { x.CONTRATOID, x.PROCESSOID });
                    table.ForeignKey(
                        name: "FK_CONTRATO_PROCESSO_CONTRATO_CONTRATOID",
                        column: x => x.CONTRATOID,
                        principalTable: "CONTRATO",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CONTRATO_PROCESSO_PROCESSOS_PROCESSOID",
                        column: x => x.PROCESSOID,
                        principalTable: "PROCESSOS",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CONTRATO_PROCESSO_PROCESSOID",
                table: "CONTRATO_PROCESSO",
                column: "PROCESSOID");
