...
namespace DeslandesApp.Infra.Data.Migrations
{
    ...
    [Migration("20260322184310_ListanulaGrupoEnvolvidos2")]
    partial class ListanulaGrupoEnvolvidos2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DeslandesApp.Domain.Models.Entities.GrupoEventoResponsavel", b =>
                {
                    ...
                    b.HasIndex("PessoaId")
                        .HasDatabaseName("IX_EVENTORESPONSAVEL_PESSOAID");
            ...
            modelBuilder.Entity("DeslandesApp.Domain.Models.Entities.GrupoTarefaEnvolvido", b =>
                {
                    ...
                    b.HasIndex("PessoaId")
                        .HasDatabaseName("IX_GRUPOTAREFAENVOLVIDO_PESOAID");

                    b.HasIndex("PessoaId1")
                        .HasDatabaseName("IX_GRUPOTAREFAENVOLVIDO_PESSOAID1");

                    b.HasIndex("TarefaId")
                        .HasDatabaseName("IX_GRUPOTAREFAENVOLVIDO_TAREFAID");
            ...
            modelBuilder.Entity("DeslandesApp.Domain.Models.Entities.GrupoEventoResponsavel", b =>
                {
                    ...
                    b.HasOne("DeslandesApp.Domain.Models.Entities.Pessoa", "Pessoa")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_EVENTORESPONSAVEL_PESSOA_PESSOAID");
            ...
            modelBuilder.Entity("DeslandesApp.Domain.Models.Entities.GrupoTarefaEnvolvido", b =>
                {
                    ...
                    b.HasOne("DeslandesApp.Domain.Models.Entities.Pessoa", null)
                        ...
                        .HasConstraintName("FK_GRUPOTAREFAENVOLVIDO_PESSOA_PESSOAID1");
